...
Version 2.62 02/10/2022
Version 2.70 07/11/2022
...
1. Self-contained projects - GFC no longer provided in a separate folder
2. Support for x64 architecture
3. Improved separation from SDL (SDL headers no longer included in gfc.h)

Changes in Version 2.62
===================

1. Compatibility with Visual Studio 2022
2. CSprite: animation information retrival functions added.

Changes in Version 2.61
===================

1. Compatibility with Visual Studio 2019
2. CSprite::GetHealth/SetHealth implementation change to use float rather than integer
...
13. CSprite::SetDirection(CVector vec) function added
